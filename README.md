...
<!-- DAO-APK-LINK:START -->
**📱 Devin Cloud 手机版 · 直接下载 APK**（安卓本体，辅助 ②）：[⬇ DevinCloud-mobile-v0.37.164.apk](https://github.com/zhouyoukang1234-spec/devin-remote/releases/download/rtflow-v0.37.164/DevinCloud-mobile-v0.37.164.apk) · 下载后允许「安装未知应用」即可装。
<!-- DAO-APK-LINK:END -->
...
>
> 🤖 **要改本仓代码的 Agent 先读 [`AGENTS.md`](AGENTS.md)**：本源认知（dao-vsix 才是主体，dao-one 只是 +Proxy Pro）、六大板块分而治之 / 网页套网页（`/shell`）、内网穿透去中心化（不需要 Cloudflare 账号）、多实例、历史踩坑清单，**正本清源、防止重蹈覆辙**。
...
|---|---|---|---|---|
| **dao-one** | `2.19.4` | `dao.dao-one` | 最终主交付：dao-vsix 二合一本源基座 + Proxy Pro 三面板子模块（折入 Devin Cloud 全功能面板），其余与 dao-vsix 完全一致。 | [Release](https://github.com/zhouyoukang1234-spec/devin-remote/releases/tag/dao-one-v2.19.4) · [⬇ VSIX](https://github.com/zhouyoukang1234-spec/devin-remote/releases/download/dao-one-v2.19.4/dao-one-2.19.4.vsix) |
| **dao-vsix** | `3.50.92` | `dao.dao-vsix` | 本源基座：rt-flow 切号视图 + Devin Cloud 全功能面板 + 本地 HTTP API（含多账号反向注入）。可单独安装。 | [Release](https://github.com/zhouyoukang1234-spec/devin-remote/releases/tag/dao-vsix-v3.50.92) · [⬇ VSIX](https://github.com/zhouyoukang1234-spec/devin-remote/releases/download/dao-vsix-v3.50.92/dao-vsix-3.50.92.vsix) |
| **rt-flow** | `4.26.6` | `devaid.rt-flow` | Devin Cloud 接入本体：对话备份 / 全量快照 / 一键回归本源 wipe / 对话额度上限。 | [Release](https://github.com/zhouyoukang1234-spec/devin-remote/releases/tag/rt-flow-v4.26.6) · [⬇ VSIX](https://github.com/zhouyoukang1234-spec/devin-remote/releases/download/rt-flow-v4.26.6/rt-flow-4.26.6.vsix) |
| **dao-proxy-pro** | `9.9.342` | `dao-agi.dao-proxy-pro` | 底层提示词隔离替换 + 外接第三方模型路由。三面板：本源观照 / 渠道配置 / 模型路由。 | [Release](https://github.com/zhouyoukang1234-spec/devin-remote/releases/tag/dao-proxy-pro-v9.9.342) · [⬇ VSIX](https://github.com/zhouyoukang1234-spec/devin-remote/releases/download/dao-proxy-pro-v9.9.342/dao-proxy-pro-9.9.342.vsix) |
| **dao-bridge** | `3.11.1` | `dao.dao-bridge` | 内网穿透本体：默认 Cloudflare 快速隧道（去中心化，无 Worker），配置账号走命名隧道；cloudflared 自愈/断点续传，随 IDE 自启。独立 addon，不与其它插件冲突。 | [Release](https://github.com/zhouyoukang1234-spec/devin-remote/releases/tag/dao-bridge-v3.11.1) · [⬇ VSIX](https://github.com/zhouyoukang1234-spec/devin-remote/releases/download/dao-bridge-v3.11.1/dao-bridge-3.11.1.vsix) |
| **rt-flow-app** | `0.37.164` | `ai.devin.rtflow` _(APK)_ | Devin Cloud 手机版 APK（安卓本体）：切号 + 内网穿透 + 网页多实例 + 浏览器自动化 + 手机本体操控 + 系统级接管 + 渐进式文档。主页可直接下载安装。 | [Release](https://github.com/zhouyoukang1234-spec/devin-remote/releases/tag/rtflow-v0.37.164) · [⬇ APK](https://github.com/zhouyoukang1234-spec/devin-remote/releases/download/rtflow-v0.37.164/DevinCloud-mobile-v0.37.164.apk) |
| **rt-flow-ios** | `0.1.0` | `ai.devin.rtflow.ios` _(IPA)_ | Devin Cloud 手机版 iOS 壳（未签名 IPA，需 TrollStore/AltStore/Sideloadly 等自签安装）：切号 + 内网穿透 + 网页多实例，复用安卓版同一套 engine JS 资产。 | [Release](https://github.com/zhouyoukang1234-spec/devin-remote/releases/tag/rtflow-ios-v0.1.0) · [⬇ IPA](https://github.com/zhouyoukang1234-spec/devin-remote/releases/download/rtflow-ios-v0.1.0/DevinCloud-mobile-ios-v0.1.0.ipa) |
